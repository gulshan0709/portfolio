  ...
  >
    <div className="h-full w-full rounded-lg border border-[#1f223c] bg-[#11152c] shadow-none shadow-gray-50 group-hover:border-violet-500 transition-all duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center p-6 gap-6">
        <div className="flex-shrink-0 w-full sm:w-32 sm:w-40 md:w-48 order-1 sm:order-2">
        ...
        <div className="flex-1 flex flex-col justify-center gap-4 mt-4 sm:mt-0 order-2 sm:order-1">
          <div>
